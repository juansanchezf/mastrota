...
public class DatabaseConnector implements AutoCloseable {
    ...
    public void crearTablas() {
        ...
        crearTabla("Empleado", "Telefono VARCHAR2(15), Numero_de_empleado INT(5) PRIMARY KEY, DNI VARCHAR2(20), Nombre VARCHAR2(100), Direccion VARCHAR2(255), Fecha_de_contratacion DATE"); 
        ...
        crearTabla("Tiene", "Numero_de_empleado INT(5), Numero_de_contrato INT(6), PRIMARY KEY(Numero_de_contrato, Numero_de_empleado), FOREIGN KEY (Numero_de_empleado) REFERENCES Empleado(Numero_de_empleado), FOREIGN KEY (Numero_de_contrato) REFERENCES Contrato(Numero_de_contrato) ");
